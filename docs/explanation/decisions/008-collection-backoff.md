...
success, and the backoff measures from it. Measuring from the last attempt would reset the
...
can never cause a lost day. Only an outage longer than the window itself can, and
