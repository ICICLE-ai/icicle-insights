...
struct ICICLESnapshotJuly2026: AsyncMigration {
  ...
  private static let additionalAccounts: [AccountSpec] = [
    AccountSpec(
      ...
      resources: [
        ...
        ResourceSpec(
          "food-security-sandbox-frontend", type: .container, metrics: [.init(.pullsAllTime, 185)]),
        ...
        ResourceSpec(
          "harp-app-eulernumber-ci", type: .container, metrics: [.init(.pullsAllTime, 140)]),
        ResourceSpec("gnnfoodflow-portal", type: .container, metrics: [.init(.pullsAllTime, 136)]),
        ResourceSpec(
          "harp-framework-local", type: .container, metrics: [.init(.pullsAllTime, 131)]),
        ResourceSpec(
          "harp-app-eulernumber-local", type: .container, metrics: [.init(.pullsAllTime, 130)]),
        ResourceSpec("array-morph", type: .container, metrics: [.init(.pullsAllTime, 130)]),
        ResourceSpec(
          "food-security-sandbox-backend", type: .container, metrics: [.init(.pullsAllTime, 124)]),
        ResourceSpec("catalogbackend", type: .container, metrics: [.init(.pullsAllTime, 124)]),
        ResourceSpec(
          "plug-n-play-megadetector-v6b", type: .container, metrics: [.init(.pullsAllTime, 113)]),
        ResourceSpec("umami", type: .container, metrics: [.init(.pullsAllTime, 99)]),
        ResourceSpec(
          "food-security-sandbox-sandbox", type: .container, metrics: [.init(.pullsAllTime, 97)]),
        ResourceSpec(
          "food-security-sandbox-param", type: .container, metrics: [.init(.pullsAllTime, 96)]),
        ResourceSpec(
          "icicle-ai-vector-service", type: .container, metrics: [.init(.pullsAllTime, 92)]),
        ResourceSpec(
          "icicle-ai-embed-service", type: .container, metrics: [.init(.pullsAllTime, 83)]),
        ResourceSpec(
          "harvest-preprocessing", type: .container, metrics: [.init(.pullsAllTime, 78)]),
        ResourceSpec("store-closure-abm", type: .container, metrics: [.init(.pullsAllTime, 68)]),
        ResourceSpec(
          "smart-labeler-frontend", type: .container, metrics: [.init(.pullsAllTime, 60)]),
        ...
        ResourceSpec(
          "opencv-image-playground", type: .container, metrics: [.init(.pullsAllTime, 38)]),
        ...
        ResourceSpec(
          "sam3-inference-service", type: .container, metrics: [.init(.pullsAllTime, 30)]),
        ...
        ResourceSpec(
          "smart-labeler-backend", type: .container, metrics: [.init(.pullsAllTime, 23)]),
        ResourceSpec("hpc-mcp-server", type: .container, metrics: [.init(.pullsAllTime, 23)]),
        ResourceSpec(
          "opencv-image-playground-bridge", type: .container, metrics: [.init(.pullsAllTime, 13)]),
        ResourceSpec("hpc-mcp-server-cpu", type: .container, metrics: [.init(.pullsAllTime, 8)]),
        ResourceSpec(
          "rag-chatbot-harvest-websocket-service", type: .container,
          metrics: [.init(.pullsAllTime, 6)]),
        ResourceSpec(
          "rag-chatbot-harvest-api-service", type: .container, metrics: [.init(.pullsAllTime, 6)]),
        ResourceSpec(
          "rag-chatbot-harvest-model-service", type: .container, metrics: [.init(.pullsAllTime, 6)]),
    ...
    AccountSpec(
      platform: .huggingface, followers: 20,
      resources: [
        ResourceSpec("foodflow_gnn_model", type: .model, metrics: []),
        ResourceSpec(
          "yolov9-animals-ae-data", type: .model, metrics: [.init(.downloadsAllTime, 151)]),
        ResourceSpec("can_benchmark", type: .dataset, metrics: [.init(.downloadsAllTime, 202)]),
        ResourceSpec(
          "organization-sic-code_smart-foodsheds", type: .dataset,
          metrics: [.init(.downloadsAllTime, 209)]),
        ResourceSpec(
          "resourceestimation_hlogencnn", type: .dataset, metrics: [.init(.downloadsAllTime, 507)]),
      ]),
  ...
  private static let repositories: [RepositorySpec] = [
    ...
    RepositorySpec(
      name: "ct-controller",
      releases: [
        .init("0.1", month: 9, year: 2024), .init("0.2", month: 5, year: 2025),
    ...
    RepositorySpec(
      name: "harvest",
      releases: [
        .init("0.9", month: 9, year: 2024), .init("1.0", month: 7, year: 2025),
        .init("1.1", month: 8, year: 2025), .init("1.2", month: 8, year: 2025),
        .init("1.3", month: 12, year: 2025), .init("1.4", month: 3, year: 2026),
      ],
    ...
    RepositorySpec(
      ...
      releases: [
        .init("0.0.1", month: 4, year: 2023), .init("0.0.10", month: 6, year: 2023),
