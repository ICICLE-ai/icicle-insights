...
struct ICICLESnapshotJuly2026: AsyncMigration {
  ...
  private static let additionalAccounts: [AccountSpec] = [
    AccountSpec(
      ...
      resources: [
        ...
        ResourceSpec(
          "food-security-sandbox-frontend", type: .container, metrics: [.init(.pulls, 185)]),
        ...
        ResourceSpec(
          "food-security-sandbox-backend", type: .container, metrics: [.init(.pulls, 124)]),
        ResourceSpec("catalogbackend", type: .container, metrics: [.init(.pulls, 124)]),
        ResourceSpec(
          "plug-n-play-megadetector-v6b", type: .container, metrics: [.init(.pulls, 113)]),
        ResourceSpec("umami", type: .container, metrics: [.init(.pulls, 99)]),
        ResourceSpec(
          "food-security-sandbox-sandbox", type: .container, metrics: [.init(.pulls, 97)]),
        ...
        ResourceSpec(
          "opencv-image-playground-bridge", type: .container, metrics: [.init(.pulls, 13)]),
        ResourceSpec("hpc-mcp-server-cpu", type: .container, metrics: [.init(.pulls, 8)]),
        ResourceSpec(
          "rag-chatbot-harvest-websocket-service", type: .container, metrics: [.init(.pulls, 6)]),
        ResourceSpec(
          "rag-chatbot-harvest-api-service", type: .container, metrics: [.init(.pulls, 6)]),
        ResourceSpec(
          "rag-chatbot-harvest-model-service", type: .container, metrics: [.init(.pulls, 6)]),
    ...
    AccountSpec(
      ...
      resources: [
        ...
        ResourceSpec(
          "organization-sic-code_smart-foodsheds", type: .dataset, metrics: [.init(.downloads, 209)]
        ),
        ResourceSpec(
          "resourceestimation_hlogencnn", type: .dataset, metrics: [.init(.downloads, 507)]),
      ]),
  ...
  private static let repositories: [RepositorySpec] = [
    ...
    RepositorySpec(
      ...
      metrics: [
        .init(.clones, 31), .init(.forks, 1), .init(.stars, 5), .init(.subscribers, 1),
        .init(.views, 3),
      ]
    ),
    RepositorySpec(
    ...
    RepositorySpec(
      ...
      metrics: [
        .init(.clones, 89), .init(.forks, 3), .init(.stars, 1), .init(.subscribers, 4),
        .init(.views, 58),
      ]
    ),
    RepositorySpec(
    ...
    RepositorySpec(
      ...
      metrics: [
        .init(.clones, 1696), .init(.forks, 2), .init(.stars, 3), .init(.subscribers, 3),
        .init(.views, 3741),
      ]
    ),
    RepositorySpec(
